...
function realTimeValidation() {
  ...
  if (userPass.value != userPass2.value) {
    return (document.getElementById("errorfield").textContent =
  ...
  if (
    ...
    return (document.getElementById("errorfield2").textContent =
  ...
  if (
    ...
    return (document.getElementById("errorfield3").textContent =
